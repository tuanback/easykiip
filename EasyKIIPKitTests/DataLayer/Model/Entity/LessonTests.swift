...
class LessonTests: XCTestCase {
  ...
  func testProficiencyCalculate_OneVocab_OneWrongAnswer_Proficiency0() throws {
    ...
    try vocab.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 0, firstLearnDate: Date(), lastTimeTest: Date())
  ...
  func testProficiencyCalculate_TwoVocab_OneCorrect_OnceWrong_Proficiency50() throws {
    ...
    try vocab1.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 1, firstLearnDate: Date(), lastTimeTest: Date())
    let vocab2 = Vocab(id: 1, word: "", translations: [:])
    try vocab2.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 0, firstLearnDate: Date(), lastTimeTest: Date())
  ...
  func testProficiencyCalculate_TwoVocab_TwoCorrect_Proficiency100() throws {
    ...
    try vocab1.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 1, firstLearnDate: Date(), lastTimeTest: Date())
    let vocab2 = Vocab(id: 1, word: "", translations: [:])
    try vocab2.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 1, firstLearnDate: Date(), lastTimeTest: Date())
    let sut = makeSut(with: [vocab1, vocab2])
    XCTAssertEqual(sut.proficiency, 100)
  }
  ...
  func testProficiencyCalculate_TwoVocab_TwoWrong_Proficiency0() throws {
    let vocab1 = Vocab(id: 0, word: "", translations: [:])
    try vocab1.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 0, firstLearnDate: Date(), lastTimeTest: Date())
    let vocab2 = Vocab(id: 1, word: "", translations: [:])
    try vocab2.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 0, firstLearnDate: Date(), lastTimeTest: Date())
    let sut = makeSut(with: [vocab1, vocab2])
    XCTAssertEqual(sut.proficiency, 0)
  ...
  func testLastTimeLearned() throws {
    let time1 = Date()
    let vocab1 = Vocab(id: 0, word: "", translations: [:])
    try vocab1.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 1, firstLearnDate: time1, lastTimeTest: time1)
    sleep(1)
    let time2 = Date()
    let vocab2 = Vocab(id: 1, word: "", translations: [:])
    try vocab2.setTestTakenData(isMastered: false, numberOfTestTaken: 1, numberOfCorrectAnswer: 1, firstLearnDate: time2, lastTimeTest: time2)
    let sut = makeSut(with: [vocab1, vocab2])
